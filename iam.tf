module "cs-folders-iam-0-computeinstanceAdminv1" {
  ...
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
      "group:gcp-developers@thinkwell.shop",
    ]
  }
}
...
module "cs-projects-iam-2-loggingviewer" {
  ...
  bindings = {
    "roles/logging.viewer" = [
      "group:gcp-logging-monitoring-viewers@thinkwell.shop",
    ]
  }
}
...
module "cs-projects-iam-3-bigquerydataViewer" {
  ...
  bindings = {
    "roles/bigquery.dataViewer" = [
      "group:gcp-security-admins@thinkwell.shop",
    ]
  }
}
...
#   projects = [
#     module.cs-svc-prod2-svc-j8yh.project_id,
#   ]
#   bindings = {
#     "roles/compute.instanceAdmin.v1" = [
...
#   projects = [
#     module.cs-svc-nonprod2-svc-j8yh.project_id,
#   ]
#   bindings = {
#     "roles/compute.instanceAdmin.v1" = [
